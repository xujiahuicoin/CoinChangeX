...
public extension UIScrollView {
     ...
     *  设置页面显示的类型
     */
    var loadType: BFRefreshLoadType? {
        set(newValue) {
     ...
     *  刷新回调
     */
    var refreshBlock: BFRefreshRefreshingBlock? {
        set(newValue) {
     ...
     *  没有网络时显示的视图
     */
    var refreshNoNetworkView: BFRefreshNoNetworkView? {
        set(newValue) {
     ...
     *  访问出错时显示的视图
     */
    var refreshRequestErrorView: BFRefreshRequestErrorView? {
        set(newValue) {
     ...
     *  没有数据显示的视图
     */
    var refreshNoDataView: BFRefreshNoDataView? {
        set(newValue) {
     ...
     *  加载中的视图
     */
    var refreshLoadingView: BFRefreshLoadingView? {
        set(newValue) {
...
public extension UIScrollView {
    ...
    func set(loadType: BFRefreshLoadType) {
