...
open class CHSeries: NSObject {
    ...
    open var chartModsXJH = [CHChartModel]()          //每个系列包含多个点线模型
...
extension CHSeries {
    ...
    public class func getVolumeWithMA(upStyle: (color: UIColor, isSolid: Bool),
        ...
        series.chartModsXJH.append(contentsOf: volumeSeries.chartModsXJH)
        series.chartModsXJH.append(contentsOf: volumeMASeries.chartModsXJH)
        return series
    }
    ...
    public class func getVolumeWithSAM(upStyle: (color: UIColor, isSolid: Bool),
                                      ...
                                      xjh_LineColor: UIColor,
                                      section: CHSection) -> CHSeries {
        let series = CHSeries()
        series.key = CHSeriesKey.sam
        let volumeSeries = CHSeries.getDefaultVolume(upStyle: upStyle, downStyle: downStyle, section: section)
        
        let volumeSAMSeries = CHSeries.getVolumeSAM(num: num, barStyle: barStyle, xjh_LineColor: xjh_LineColor, section: section)
        
        series.chartModsXJH.append(contentsOf: volumeSeries.chartModsXJH)
        series.chartModsXJH.append(contentsOf: volumeSAMSeries.chartModsXJH)
        return series
    }
    ...
    public class func getMACD(_ difc: UIColor,
        ...
        bar.section = section
        series.chartModsXJH = [bar, dif, dea]
        return series
    }
    ...
    public class func getBOLL(_ bollc: UIColor, ubc: UIColor, lbc: UIColor, section: CHSection) -> CHSeries {
        ...
        lb.section = section
        series.chartModsXJH = [boll, ub, lb]
        return series
    }
    ...
    public class func getVolumeSAM(num: Int,
        ...
        let sam = CHChartModel.getLine(xjh_LineColor, title: "\(CHSeriesKey.sam)\(num)", key: "\(CHSeriesKey.sam)_\(num)_\(valueKey)")
        sam.section = section
    ...
    public class func getPriceSAM(num: Int,
        ...
        series.chartModsXJH = [sam, candle]
        return series
    }
