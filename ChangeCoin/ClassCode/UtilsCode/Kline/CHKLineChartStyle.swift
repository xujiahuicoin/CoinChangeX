...
open class CHKLineChartStyle {
    ...
    //线条颜色
    open var xjh_LineColor: UIColor = UIColor.clear
...
public extension CHKLineChartStyle {
    ...
    public static var base: CHKLineChartStyle {
        ...
        style.xjh_LineColor = UIColor(white: 0.2, alpha: 1)
        ...
        priceSeries.chartModsXJH.first?.ultimateValueStyle = .arrow(UIColor(white: 0.8, alpha: 1))
