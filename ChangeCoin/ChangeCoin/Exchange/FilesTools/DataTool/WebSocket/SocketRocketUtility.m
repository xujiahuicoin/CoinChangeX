...
- (void)reConnect
{
    ...
    ///判断网络
//    [IsOnline isConnectionAvailableWithBlock:^{
        //有网
...
- (void)initHeartBeat
{
    dispatch_main_async_safe(^{
        ...
        self->heartBeat = [NSTimer timerWithTimeInterval:15 target:self selector:@selector(sentheart) userInfo:nil repeats:YES];
