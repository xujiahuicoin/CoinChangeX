...
static NSMutableDictionary * XsyFilePathDict;

@implementation XsyFileManager

+ (void)load
{
    XsyFilePathDict = [NSMutableDictionary dictionary];
}
