//
//  XJH_Okex_CurrencyListView.swift
//  ChangeCoin
//
...
class XJH_Okex_CurrencyListView: XJHBaseView,XJHViewEventsDelegate {
    ...
    func CreatUI(){
        ...
        XJH_currencyListTab = XJH_Okex_CurrencyListTV.view()
...
//        if transactoinPair_List == nil {
            ...
            self.transactoinPair_List = ["BTC":XJH_UserModel.sharedInstance.coinBTC,"ETH":XJH_UserModel.sharedInstance.coinETH,"USDT":XJH_UserModel.sharedInstance.coinUSDT]
            //刷新列表
...
//        }
    ...
    ///---显示隐藏 交易对列表-
    func xjh_PriShowOrhideCurrencyList(showV : Bool) {
